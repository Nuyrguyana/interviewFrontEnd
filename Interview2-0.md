...
|**async**|**defer**|
|-|-|
|Указывает браузеру загружать скрипт асинхронно. Это означает, что браузер будет продолжать обработку
...
|Указывает браузеру загружать скрипт отложенно. Это означает браузер будет продолжать обработку HTML-документа,
